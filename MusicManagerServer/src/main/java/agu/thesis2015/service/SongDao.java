...
public interface SongDao {
	...
	public Response getListSongShard(String field, int page, int size, Direction direction);

	/**
	 * Change state song Sharded or not sharded
	 * 
	 * @param username
	 * @param id
	 * @param state
